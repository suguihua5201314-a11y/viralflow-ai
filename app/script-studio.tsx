...
export default function ScriptStudio(props:Props) {
  ...
  return <section className="os-script-studio">
    <VNextScriptHeader product={props.form.product} country={props.form.country} platform={platform} saved={savedNotice} loading={props.loading} disabled={!props.inputReady||props.loading||props.raceLoading||!providerReady} hasScript={Boolean(draftScript)} onGenerate={()=>props.onGenerate(controls(1))} onHistory={()=>props.onNavigate("history")}/>
