export type ActiveView = "dashboard" | "projects" | "create" | "images" | "assets" | "video" | "director" | "voice" | "breakdown" | "replicate" | "checker" | "library" | "products" | "reviews" | "history" | "monitor";
...
export const viewMeta: Record<ActiveView, { label: string; eyebrow: string; description: string }> = {
  ...
  assets: { label: "Project Asset Library", eyebrow: "项目资产", description: "浏览、筛选和复用当前项目的真实创作资产" },
  ...
  history: { label: "脚本历史", eyebrow: "知识与资产", description: "查看团队已经生成和保存的脚本" },
