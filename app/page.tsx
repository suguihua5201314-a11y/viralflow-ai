...
export default function Home() {
  ...
  >
      ...
      {active === "director" && <ShootingDirector input={directorInput} currentProjectId={projectMemory.workspace.currentProjectId} onNavigate={view=>setActive(view)} onChange={value=>{updateProjectMemory({directorResult:value},{stage:"导演",progress:72});saveWorkspaceSnapshot({activeView:"director"});}} />}
