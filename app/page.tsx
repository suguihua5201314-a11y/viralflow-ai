...
export default function Home() {
  ...
  function adoptReplication(script:StructuredScript,reference:string,next:"create"|"director"="create"){const generated=script as Script;const adopted={...script,id:Date.now(),product:generated.product||form.product,language:generated.language||form.language,country:generated.country||form.country,style:script.style||form.style,alternateHooks:generated.alternateHooks||[],scenes:script.scenes||[],sourceCaseReference:reference} as Script;setForm(prev=>({...prev,product:adopted.product,language:adopted.language,country:adopted.country}));setReferenceScript(reference);setResult(adopted);setRaceResults([]);setActive(next);}
