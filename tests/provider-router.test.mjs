...
test("unconfigured GPT sends no request and returns explicit provider metadata",async()=>{
...
test("router isolates provider I/O while Studio keeps selector in React session",async()=>{
 ...
 for(const marker of ["ARK_API_KEY","ARK_MODEL_ID","ARK_ENDPOINT_ID","ARK_BASE_URL","OPENAI_API_KEY","OPENAI_MODEL","unauthorized","invalid_model_or_endpoint","rate_limit","timeout"])assert.ok(router.includes(marker),marker);
